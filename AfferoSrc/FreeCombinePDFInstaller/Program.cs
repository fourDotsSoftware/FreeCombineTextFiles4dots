            ...
            else if (args[0] == "-settings")
            {
                ...
                try
                {
                    ...
                    if (key != null)
                    {
                        ...
                        {
                            if (key.GetValue("Free Combine Text 4dots") != null)
                            {
                                key.DeleteValue("Free Combine Text 4dots");
                            }

                            if (key.GetValue("Free Combine Text 4dots") == null)
                            {
                                key.SetValue("Free Combine Text 4dots", "\"" + Application.StartupPath + "\\FreeCombinePDFFolderWatcher.exe\" -cu");
                            }
                        }
                        else
                        {
                ...
                try
                {
                    ...
                    if (key != null)
                    {
                        if (startupWindows && cu)
                        {
                            ...
                            if (key.GetValue("Free Combine Text 4dots") == null)
                            {
                                key.SetValue("Free Combine Text 4dots", "\"" + Application.StartupPath + "\\FreeCombinePDFFolderWatcher.exe\" -lm");
                            }
                        }
                        else
                        {
                ...
                if (cu)
                {
                    RegistryHelper2.SetKeyValue("Free Combine Text 4dots", "WatchFolders", args[3]);
                    RegistryHelper2.SetKeyValue("Free Combine Text 4dots", "AppFilepath", args[4]);
                    RegistryHelper2.SetKeyValue("Free Combine Text 4dots", "ConvertArgs", args[5]);
                }
                else
                {
                    RegistryHelper2.SetKeyValueLM("Free Combine Text 4dots", "WatchFolders", args[3]);
                    RegistryHelper2.SetKeyValueLM("Free Combine Text 4dots", "AppFilepath", args[4]);
                    RegistryHelper2.SetKeyValueLM("Free Combine Text 4dots", "ConvertArgs", args[5]);
                }
                return 0;
            }
            else
