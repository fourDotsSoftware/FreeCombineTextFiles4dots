...
{ 
    ...
    Module.args[k].ToLower().StartsWith("-outputfile:"))
        ...
        {
            string msg = "Combines multiple PDF documents into a single PDF document.\n\n" +
            ...
            "/? : show help\n\n\n" +
            "Example :\n" +
            "FreeCombinePDF.exe \"c:\\documents\\invoice.pdf\" \"c:\\documents\\invoice2.pdf\" "+
            "\"PDFPASSWORD\" \"c:\\documents\\invoice3.pdf\" /outputfile:\"c:\\documents\\mergedPDF.pdf\" ";
