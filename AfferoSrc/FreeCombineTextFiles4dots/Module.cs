...
namespace FreeCombineTextFiles4dots
{
    class Module
    {
        ...
        public static string ApplicationName = "Free Combine Text 4dots";
        ...
        public static string HelpURL = "https://softpcapps.com/free-combine-text/how-to-use.php";
        public static string ProductWebpageURL = "https://softpcapps.com/free-combine-text/";
        public static string BuyURL = "https://softpcapps.com/store/buy-free-combine-text.php";
        public static string VersionURL = "http://cssspritestool.com/versions/free-combine-text.txt";

        public static string TipText = TranslateHelper.Translate("Great application to combine !");
