...
; Start
  ...
  !define MUI_FILE "FreeCombinePDF"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Free Combine Text 4dots"
  !define PRODUCT_SHORTCUT "Free Combine Text 4dots"
  !define PRODUCT_VERSION "1.0"
  
  !define MUI_ICON "free-combine-text-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Free Combine Text 4dots"
  OutFile "FreeCombinePDFSetup.exe"

  InstallDir "$PROGRAMFILES\softpcapps Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\softpcapps Software\Free Combine Text 4dots" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Free Combine Text 4dots - User's Manual.url.lnk" "$INSTDIR\Free Combine Text 4dots - User's Manual.url" "" "$INSTDIR\Free Combine Text 4dots - User's Manual.url" 0
...
!endif
  ...
  !insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\FreeCombinePDFExt64.dll $SYSDIR\FreeCombinePDFExt.dll $SYSDIR
  SetRegView 64
...
${Else}
  ...
  !insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\FreeCombinePDFExt32.dll $SYSDIR\FreeCombinePDFExt.dll $SYSDIR
...
;!  inetc::get /SILENT "http://softpcapps.com/installmonetizer/AudioJoinerExpert.php" "$PLUGINSDIR\Installmanager.exe" /end
...
;Add files
 ...
 Call IsDotNetInstalledAdv
  ...
  File "Free Combine Text 4dots - User's Manual.url";
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\softpcapps Software\Free Combine Text 4dots" "" $INSTDIR
  WriteRegStr HKLM "Software\softpcapps Software\Free Combine Text 4dots" "InstallationDirectory" $INSTDIR
...
!endif
  ...
  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\FreeCombinePDFExt64.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
; 32bit things here
  ...
  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\FreeCombinePDFExt32.dll
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\softpcapps Software\Free Combine Text 4dots"
  DeleteRegKey HKCU "Software\softpcapps Software\Free Combine Text 4dots"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://softpcapps.com/free-combine-text/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://softpcapps.com/free-combine-text/how-to-use.php?afterinstall=true"
FunctionEnd
