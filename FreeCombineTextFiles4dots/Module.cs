...
namespace FreeCombineTextFiles4dots
{
    class Module
    {
        ...
        public static string ApplicationName = "Free Combine Text Files 4dots";
        ...
        public static string DownloadURL = "https://softpcapps.com/d/FreeCombineTextFiles4dots/";
        public static string HelpURL = "https://softpcapps.com/free-combine-text-files/how-to-use.php";
        public static string ProductWebpageURL = "https://softpcapps.com/free-combine-text-files/";
        public static string BuyURL = "https://softpcapps.com/store/buy-free-combine-text-files.php";
        public static string VersionURL = "http://cssspritestool.com/versions/free-combine-text-files.txt";

        public static string TipText = TranslateHelper.Translate("Great application to combine Text Files !");
        ...
        public static string TempFolder
        {
            get
            {
                string path = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "FreeCombineTextFiles4dots");
