...
;copy translations end
  ...
  !define MUI_FILE "FreeCombineTextFiles4dots"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Free Combine Text Files 4dots"
  !define PRODUCT_SHORTCUT "Free Combine Text Files 4dots"
  !define PRODUCT_VERSION "1.0"
  
  !define MUI_ICON "free-combine-text-files-4dots-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Free Combine Text Files 4dots"
  OutFile "FreeCombineTextFiles4dotsSetup.exe"

  InstallDir "$PROGRAMFILES\softpcapps Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\softpcapps Software\Free Combine Text Files 4dots" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Free Combine Text Files 4dots - User's Manual.url.lnk" "$INSTDIR\Free Combine Text Files 4dots - User's Manual.url" "" "$INSTDIR\Free Combine Text Files 4dots - User's Manual.url" 0
...
File "signedn\${MUI_FILE}.exe"
  ...
  File "Free Combine Text Files 4dots - User's Manual.url";
...
;begin new uninstall strings
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\softpcapps Software\Free Combine Text Files 4dots" "" $INSTDIR
  WriteRegStr HKLM "Software\softpcapps Software\Free Combine Text Files 4dots" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\softpcapps Software\Free Combine Text Files 4dots"
  DeleteRegKey HKCU "Software\softpcapps Software\Free Combine Text Files 4dots"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://softpcapps.com/free-combine-text-files/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://softpcapps.com/free-combine-text-files/how-to-use.php?afterinstall=true"
FunctionEnd
